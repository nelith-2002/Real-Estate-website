...
const Prop4Page = () => {
  ...
  const property = properties.properties.find((prop) => prop.id === 'prop4');

  const carouselImages = [
    '/src/assets/images/prop4pic1small.png',
    '/src/assets/images/prop4Carousel1.jpg',
    '/src/assets/images/prop4Carousel2.jpg',
    '/src/assets/images/prop4Carousel3.jpg',
    '/src/assets/images/prop4Carousel4.jpg',
    '/src/assets/images/prop4Carousel5.jpg',
    '/src/assets/images/prop4Carousel6.jpg',
    '/src/assets/images/prop4Carousel7.jpg',
  ];
          ...
          <Tabs defaultActiveKey="description" id="property-tabs" className="mb-3">
            ...
            <Tab eventKey="floorplan" title="Floor Plan">
              <Row className="justify-content-center mt-3">
                <Col xs={12} md={8}>
                  <img
                    src="/src/assets/images/prop4floorplan1.jpg"
                    alt="Floor Plan"
                    className="img-fluid"
