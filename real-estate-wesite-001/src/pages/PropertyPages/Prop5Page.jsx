...
const Prop5Page = () => {
  ...
  const property = properties.properties.find((prop) => prop.id === 'prop5');

  // Array of images for the carousel
  const carouselImages = [
    '/src/assets/images/prop5pic1small.png',
    '/src/assets/images/prop5Carousel1.jpg',
    '/src/assets/images/prop5Carousel2.jpg',
    '/src/assets/images/prop5Carousel3.jpg',
    '/src/assets/images/prop5Carousel4.jpg',
    '/src/assets/images/prop5Carousel5.jpg',
    '/src/assets/images/prop5Carousel6.jpg',
    '/src/assets/images/prop5Carousel7.jpg',
  ];
          ...
          <Tabs defaultActiveKey="description" id="property-tabs" className="mb-3">
            ...
            <Tab eventKey="floorplan" title="Floor Plan">
              <Row className="justify-content-center mt-3">
                <Col xs={12} md={8}>
                  <img
                    src="/src/assets/images/prop5floorplan1.jpg" // Ensure this image exists
                    alt="Floor Plan"
                    className="img-fluid"
